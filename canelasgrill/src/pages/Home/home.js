        ...
        <AreaHome>
           <div className="imagemdestaque">
                <div className="container">
                    ...
                    <p className="descricao"> Nosso principal objetivo é atender as demandas e paladares de diversos tipos de clientes.
                    Oferecemos um padrão elevado de hamburgueres e acompanhamentos, para que todos os clientes saiam satisfeitos.
                    Além de um ambiente agradável, oferecemos por meio desse site a possibilidade de reserva.
